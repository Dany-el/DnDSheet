...
object UiUtils {
    ...
    val availableFilters: List<SpellFilter> = listOf(
        SpellFilter.All,
        SpellFilter.ByLevel(0),
        SpellFilter.ByLevel(1),
        SpellFilter.ByLevel(2),
        SpellFilter.ByLevel(3),
        SpellFilter.ByLevel(4),
        SpellFilter.ByLevel(5),
        SpellFilter.ByLevel(6),
        SpellFilter.ByLevel(7),
        SpellFilter.ByLevel(8),
        SpellFilter.ByLevel(9),
        SpellFilter.Concentration,
        SpellFilter.Ritual,
    )
