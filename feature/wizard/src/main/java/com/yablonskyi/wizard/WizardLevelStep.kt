        ...
        Surface(
            ...
            Row(
                ...
                Column {
                    ...
                    Text(
                        text = "$selectedClassHitDice × $level",
...
private fun WizardLevelStepPreview() {
    PreviewThemeWrapper.Preview {
        WizardLevelStep(
            selectedClassHitDice = PreviewUtils.fighter.hitDice,
            level = PreviewUtils.levelState.level,
            calculatedHp = PreviewUtils.levelState.calculatedHp,
            onLevelChange = {}
        )
    }
}
