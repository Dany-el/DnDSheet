    ...
    OutlinedCard(
        ...
        Column(
            ...
            FlowRow(
                ...
                if (cls.isHomebrew) WizardChip(text = stringResource(R.string.homebrew))
            }
            // Saving throws
...
private fun WizardClassStepPreview() {
    PreviewThemeWrapper.Preview {
        WizardClassStep(
            origClasses = PreviewUtils.origClasses,
            homebrewClasses = PreviewUtils.homebrewClasses,
            query = "", onQueryChange = {},
            selectedClass = PreviewUtils.fighter, onClassSelected = {}
        )
    }
}